...
Este é um projeto de didático desenvolvido em Laravel (8.75) e React JS (18.2.0) com o objetivo de aplicar os conhecimentos de Laravel e React JS, integrando as duas tecnologias.
O framework Laravel foi definido para a construção do back-end e a biblioteca React JS para o front-end.

O sistema F1 Data (todos os direitos reservados à instituição Formula 1) tem como objetivo cadastrar equipes e pilotos de Formula 1, com alguns dados sobre estes tópicos.
